    ...
    <section id="analyzer" className="border border-slate-300 bg-white" data-testid="analyzer-section">
      ...
      <div className="p-6 md:p-8">
        ...
        <p className="mt-4 text-slate-600 max-w-2xl">
          Paste any news article URL. Our fine-tuned RoBERTa model analyzes the content and
          classifies it as <strong className="text-emerald-700">REAL</strong> or{" "}
          <strong className="text-red-700">FAKE</strong>, backed by an AI-generated forensic
          explanation.
        </p>
